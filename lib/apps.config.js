...
const TaskManagerApp = dynamic(() => import('../components/apps/TaskManagerApp'), { ssr: false });
...
const TrashApp = dynamic(() => import('../components/apps/TrashApp'), { ssr: false });
const GamesHubApp = dynamic(() => import('../components/apps/GamesHubApp'), { ssr: false });
const NotepadApp = dynamic(() => import('../components/apps/NotepadApp'), { ssr: false });
const AchievementsApp = dynamic(() => import('../components/apps/AchievementsApp'), { ssr: false });
const SystemMonitorApp = dynamic(() => import('../components/apps/SystemMonitorApp'), { ssr: false });
...
export const APPS_CONFIG = [
    ...
    },
    {
        ...
        title: 'Achievements',
        label: 'Achievements',
        startMenuLabel: 'Trophies',
        spotlightName: 'Achievements',
        spotlightEmoji: '🏆',
        spotlightKeywords: 'achievements, trophies, badges, unlocks, progress',
        iconSrc: '/icon_achievements.svg',
    ...
    },
    {
        ...
        startMenuLabel: 'Monitor',
        spotlightName: 'System Monitor',
        spotlightEmoji: '📈',
        spotlightKeywords: 'analytics, stats, monitor, system, usage, sessions',
        iconSrc: '/icon_system_monitor.svg',
